...
Post.create!(title: "Breakthroughs in Cloud Computing", body: "Our cloud solutions offer unparalleled scalability, security, and performance, making digital transformation smoother and more accessible than ever.", image: "https://picsum.photos/640/480?random=6", user_id: user1.id)
